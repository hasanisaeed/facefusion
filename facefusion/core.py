...
def parse_args() -> None:
	...
	program.add_argument('--frame-processors', dest = 'frame_processors', default = ['face_swapper'], nargs = '+')
	program.add_argument('--ui-layouts', dest = 'ui_layouts', default = ['default'], nargs = '+')
